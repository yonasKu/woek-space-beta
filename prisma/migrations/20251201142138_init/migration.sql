...
-- CreateIndex
CREATE INDEX "outlines_organizationId_idx" ON "outlines"("organizationId");
...
-- AddForeignKey
ALTER TABLE "outlines" ADD CONSTRAINT "outlines_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
